...
const dict = {
  ro: {
    ...
    booking: {
      ...
      text: 'Poți face o programare online, iar detaliile legate de disponibilitate vor fi confirmate direct.',
      cta: 'Programează o ședință',
      placeholder: 'Link-ul de programare va fi disponibil în curând — [LINK PROGRAMARE]',
    },
    faq: {
  ...
  en: {
    ...
    booking: {
      ...
      text: 'You can book online, and availability details will be confirmed directly.',
      cta: 'Book a session',
      placeholder: 'The booking link will be available soon — [BOOKING LINK]',
    },
    faq: {
